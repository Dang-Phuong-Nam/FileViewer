        ...
        private final MenuItem.OnMenuItemClickListener menuItemClickListener = item -> {
            ...
            switch (item.getItemId()) {
                ...
                case 3:
                    ...
                    builder3.setTitle("Enter new file name").setView(input).setPositiveButton("Confirm", (dialogInterface, i) -> {
                ...
                case 4:
                    ...
                    builder4.setTitle("Are you sure?").setPositiveButton("Yes", (dialogInterface, i) -> {
