    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (currentPath != null) {
            ...
            if (item.getItemId() == R.id.new_folder) {
                ...
                builder.setTitle("New Folder").setView(input).setPositiveButton("OK", (dialogInterface, i) -> {
            ...
            if (item.getItemId() == R.id.new_txt_file) {
                ...
                final EditText input = new EditText(this);
                input.setPadding(50, 40, 50, 40);
                input.setHint("New text file");
                input.setInputType(InputType.TYPE_CLASS_TEXT);
                builder.setTitle("New Text File").setView(input).setPositiveButton("OK", (dialogInterface, i) -> {
                    String name = input.getText().toString();
